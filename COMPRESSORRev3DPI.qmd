...
Rev3DPIPROMTotal <- Rev3DPIMaster |> reframe(
  ...
  ADL_24mth        = c(sum(!is.na(HOOS12_DailyLiving_TotalScore_12months)),   quantile(HOOS12_DailyLiving_TotalScore_24months,   c(0.25,0.5,0.75), na.rm = TRUE)),
...
```{r}
#| label: tbl-HOOS
#| tbl-cap: "Summary of HOOS subscales at 2 and 5 years"
