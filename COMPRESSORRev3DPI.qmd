...
Adverse events were detected in 43% of the cohort as shown in @tbl-comp, with an average detection with 30 days of surgery.
...
```{r}
Rev3DPIFail <- Rev3DPIMaster4 |> filter(
  TreatmentStatus == "Failed"
) |> dplyr::select(
  TreatmentID,
  DateTreatment,
...
There were 2 cases of dislocation and a failure of an adjacent femoral replacement that could not be rated with the Henderson system in relation to the 3DPI component. There was one case of loosening at 6.6 years followup (Henderson 2B) and one at 6 months (Henderson 2A). One case of periprosthetic infection (Henderson 4A) presented at 10 months. 
